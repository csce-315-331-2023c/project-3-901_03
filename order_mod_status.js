...
router.post('/', async(req, res) => {
    await pool
        .query("UPDATE orders SET status = '" + req.body.orderstatus + "' WHERE order_date = '" + req.body.orderdate + "' AND order_time = '" + req.body.ordertime + "' AND cashier_id = "+ req.body.ordercashier + ";");
